...
> 🌐 **Live Demo:** [https://pdf2md.doc-tool.qihangsoftware.cn/](https://pdf2md.doc-tool.qihangsoftware.cn/) — Try it online, no setup required
...
3. Choose options:
  ...
  - ✅ **Filter Header/Footer** — Automatically skip repeated headers and footers
  - ✅ **Use HTML for Merged Cells** — Render tables with merged cells as HTML `<table>`
...
python convert.py input.pdf --html-table         # Render merged-cell tables as HTML
```
...
| `skip_header_footer` | bool | — | `true` | Filter repeated headers/footers |
| `html_merged_table` | bool | — | `false` | Render merged-cell tables as HTML |
